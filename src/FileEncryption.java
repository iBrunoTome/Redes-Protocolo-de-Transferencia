...
// Algoritmo obtido em: http://javaingrab.blogspot.com.br/2013/03/encrypting-and-decryptinhg-file.html
...
public class FileEncryption {
	...
	public FileEncryption(String algo, String path) {
	...
	public void decrypt() throws Exception {
		...
		try (CipherInputStream cin = new CipherInputStream(fis, decrypt)) {
			try (FileOutputStream fos = new FileOutputStream(path.substring(0,
					path.lastIndexOf(".")))) {
				copy(cin, fos);
			}
		}
